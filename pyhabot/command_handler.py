...
COMMANDS = [
    ...
    {"command": "remove",          "arguments": [("watchid", int)],               "help": "Töröl egy létező hirdetésfigyelőt."},
    {"command": "list",            "arguments": [],                               "help": "Listázza a felvett hirdetésfigyelőket."},
    {"command": "info",            "arguments": [("watchid", int)],               "help": "Lekéri egy hirdetésfigyelő adatait."},
    {"command": "seturl",          "arguments": [("watchid", int), ("url", str)], "help": "Módosítja egy hirdetésfigyelő URL-jét."},
    {"command": "notifyon",        "arguments": [("watchid", int)],               "help": "Beállítja a jelenlegi chat-et az értesítések megjelenítésehez."},
    {"command": "setwebhook",      "arguments": [("watchid", int), ("url", str)], "help": "Beállítja a webhookot egy hirdetésfigyelőhöz."},
    {"command": "unsetwebhook",    "arguments": [("watchid", int)],               "help": "Kitörli a webhookot egy hirdetésfigyelőtől."},
    {"command": "rescrape",        "arguments": [("watchid", int, "?")],          "help": "Törli a mentett hirdetéseket és újra lekéri azokat."},
    {"command": "listads",         "arguments": [("watchid", int)],               "help": "Lekéri az hirdetésfigyelőhöz tarozó hirdetéseket."},
    {"command": "adinfo",          "arguments": [("adid", int)],                  "help": "Lekéri a hirdetés adatait."},
    {"command": "setpricealert",   "arguments": [("adid", int)],                  "help": "Beállít árváltozás értesítőt egy hirtetéshez."},
    {"command": "unsetpricealert", "arguments": [("adid", int)],                  "help": "Beállít árváltozás értesítőt egy hirtetéshez."},
